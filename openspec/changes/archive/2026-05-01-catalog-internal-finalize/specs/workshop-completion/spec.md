# Workshop Completion — Delta Spec

Purpose: Automatically transition PUBLISHED workshops whose scheduled end time has passed to COMPLETED status, completing the workshop lifecycle documented in screens.md (SCR-W15, SCR-W16).
